<?php
function switcher_calculator_shortcode() {
    ob_start();
    ?>
    <form class="wmcForm" id="mortgage_form" data-loantype="switcher">
      <div class="wmcHeader">
          ...
          <div class="wmcRow">
            <div class="wmcCol">
              <div class="wmcInput">
                ...
                <input type="text" placeholder="€1,200" id="wmcMonthlyPayments">
              </div>
            </div>
            <div class="wmcCol">
              <div class="wmcInput">
                <label for=""> Remaining Term (years) </label>
                <input type="text" placeholder="20" id="wmcRemainingTerm">
              </div>
            </div>
          </div>
...
add_shortcode('switcher_calculator', 'switcher_calculator_shortcode');
