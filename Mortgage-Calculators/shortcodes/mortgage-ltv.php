<?php
function mortgage_ltv_shortcode() {
    ob_start(); ?>
    <form class="wmcForm">
      <div class="wmcHeader">
          ...
          <div class="wmcRow">
            <div class="wmcCol">
              <div class="wmcInput">
                ...
                <span class="wmcFeedBack fbMortgageAmount">You can borrow up to a maximum of 4 times your gross annual income.</span>
              </div>
            </div>
            <div class="wmcCol">
              <div class="wmcInput">
          ...
          <div class="wmcRow">
            <div class="wmcCol">
              <div class="wmcInput">
                ...
                <span><strong>LTV:</strong> <span id="wmcLTV">-</span>
              </div>
            </div>
          </div>
...
add_shortcode('mortgage_ltv', 'mortgage_ltv_shortcode');
